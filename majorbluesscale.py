# Program to generate the sounds of notes of a major blues scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a major blues scale
    notes_interval = [2, 1, 1, 3, 2, 3, 3]
    rev_interval = [0, 3, 2, 3, 1, 1, 2]
    tones_fwd, tones_rev = [], []
    
    print(f'The frequencies in Hz of notes in the {notescale} major blues scale in ascending order')
    ...
    print()
    print(f'The frequencies in Hz of notes in the {notescale} major blues scale in descending order')
    ...
    # Return list of frequencies in the ascending and descending notes of the major blues scale    
...
def fmain(tones_fwd, tones_rev):
    ...
    # Sleep for 1 second before playing the notes of major blues scale in the descending order
    time.sleep(1)
...
# Scale list for which the major blues scale will be played in sequence
